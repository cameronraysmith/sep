...
\end{align*}
We can similarly describe $G$ as (excluding factors of $\frac{1}{2}$ for all terms on the right hand side)
\begin{align*}
((p_1, \ldots , p_4), \ldots, (p_{13},\ldots,p_{16})) \mapsto &(p_1 p_{13} + p_5 p_9, p_1 p_{15} + p_5 p_{11}, p_1 p_{14} + p_6 p_9, p_1 p_{16} + p_{6} p_{11},\\
& p_3 p_{13} + p_{7} p_{9}, p_3 p_{15} + p_{7} p_{11}, p_3 p_{14} + p_{8} p_{9},p_3 p_{16} + p_{8} p_{11},\\
& p_2 p_{13} + p_{5} p_{10}, p_2 p_{15} + p_{5} p_{12}, p_2 p_{14} + p_{6} p_{10}, p_2 p_{16} + p_{6} p_{12},\\
& p_4 p_{13} + p_{7} p_{10}, p_4 p_{15} + p_{7} p_{12}, p_4 p_{14} + p_{8} p_{10}, p_4 p_{16} + p_{8} p_{12}),
\end{align*}
which implies the equations
\begin{equation}
\begin{aligned}\label{eq:locglobsys}
q_1 &= \frac{p_1 p_{13} + p_5 p_9}{2} & 
q_2 &= \frac{p_1 p_{15} + p_5 p_{11}}{2}\\
q_3 &= \frac{ p_1 p_{14} + p_6 p_9}{2}&
q_4 &= \frac{ p_1 p_{16} + p_{6} p_{11}}{2}\\
q_5 &= \frac{ p_3 p_{13} + p_{7} p_{9}}{2}&
q_6 &= \frac{ p_3 p_{15} + p_{7} p_{11}}{2}\\
q_7 &= \frac{ p_3 p_{14} + p_{8} p_{9}}{2}&
q_8 &= \frac{ p_3 p_{16} + p_{8} p_{11}}{2}\\
q_9 &= \frac{ p_2 p_{13} + p_{5} p_{10}}{2}&
q_{10} &= \frac{ p_2 p_{15} + p_{5} p_{12}}{2}\\
q_{11} &= \frac{ p_2 p_{14} + p_{6} p_{10}}{2}&
q_{12} &= \frac{ p_2 p_{16} + p_{6} p_{12}}{2}\\
q_{13} &= \frac{ p_4 p_{13} + p_{7} p_{10}}{2}&
q_{14} &= \frac{ p_4 p_{15} + p_{7} p_{12}}{2}\\
q_{15} &= \frac{ p_4 p_{14} + p_{8} p_{10}}{2}&
q_{16} &= \frac{ p_4 p_{16} + p_{8} p_{12}}{2}
\end{aligned}
\end{equation}
The question remains as to whether the right hand sides of equations \ref{eq:locglobsys} can represent a normalized probability distribution so that the $q_i$ defined in this way satisfy $\sum_{i=1}^{16} q_i = 1$.
\section*{Discussion}
