...
\end{align*}
We can similarly describe $G$ as
\begin{align*}
...
q_1 &= p_1 p_{13} + p_5 p_9\\
q_2 &= p_1 p_{15} + p_5 p_{11}\\
q_3 &= p_1 p_{14} + p_6 p_9\\
q_4 &= p_1 p_{16} + p_{6} p_{11}\\
q_5 &= p_3 p_{13} + p_{7} p_{9}\\
q_6 &= p_3 p_{15} + p_{7} p_{11}\\
q_7 &= p_3 p_{14} + p_{8} p_{9}\\
q_8 &= p_3 p_{16} + p_{8} p_{11}\\
q_9 &= p_2 p_{13} + p_{5} p_{10}\\
q_{10} &= p_2 p_{15} + p_{5} p_{12}\\
q_{11} &= p_2 p_{14} + p_{6} p_{10}\\
q_{12} &= p_2 p_{16} + p_{6} p_{12}\\
q_{13} &= p_4 p_{13} + p_{7} p_{10}\\
q_{14} &= p_4 p_{15} + p_{7} p_{12}\\
q_{15} &= p_4 p_{14} + p_{8} p_{10}\\
q_{16} &= p_4 p_{16} + p_{8} p_{12}
\end{aligned}
\end{equation}
The question remains as to whether the right hand sides of equations \ref{eq:locglobsys} remain a normalized probability distribution so that the $q_i$ defined in this way satisfy $\sum_{i=1}^{16} q_i = 1$.
\section*{Discussion}
