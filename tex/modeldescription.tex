...
\end{aligned}
\end{equation}
that result from substituting the numbers from \ref{fig:inconsistentthreecycle}A into \ref{eq:threecycinequalities}. The global consistency conditions, however, impose four additional constraints which can be derived by simple elimination of variables
\begin{equation}
