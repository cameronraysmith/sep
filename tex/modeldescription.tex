...
A \emph{gene regulatory network module} is represented by a subset of genes, $O \subseteq L$. A gene regulatory network may then be represented by a collection of subsets of genes, $\mathcal{G} \subseteq \mathcal{P}(L)$, which satisfies the following two conditions:
\begin{enumerate}
